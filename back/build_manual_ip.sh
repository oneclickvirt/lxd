...
# lxc exec "$name" -- curl -L https://raw.githubusercontent.com/spiritLHLS/lxd/main/scripts/ssh.sh -o ssh.sh
...
# lxc exec "$name" -- curl -L https://raw.githubusercontent.com/spiritLHLS/lxd/main/scripts/config.sh -o config.sh
