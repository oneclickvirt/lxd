...
lxc config set "$1" root limits.read 200MB
lxc config set "$1" root.limits.write 200MB
lxc config set "$1" root limits.read 150Iops
lxc config set "$1" root limits.write 150Iops
lxc config set "$1" root limits.cpu.priority 0
lxc config set "$1" root limits.disk.priority 0
lxc config set "$1" root limits.network.priority 0
lxc start "$1"
